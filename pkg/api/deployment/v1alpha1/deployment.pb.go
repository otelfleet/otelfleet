...
type ListCollectorsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Collectors    []*CollectorView       `protobuf:"bytes,1,rep,name=collectors,proto3" json:"collectors,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListCollectorsResponse) GetCollectors() []*CollectorView {
	if x != nil {
		return x.Collectors
	}
	return nil
...
type CollectorView struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Desc          *CollectorDescription  `protobuf:"bytes,1,opt,name=desc,proto3" json:"desc,omitempty"`
...
func (x *CollectorView) GetDesc() *CollectorDescription {
	if x != nil {
		return x.Desc
	}
	return nil
...
const file_pkg_api_deployment_v1alpha1_deployment_proto_rawDesc = "" +
	...
	"withStatus\"\\\n" +
	"\x16ListCollectorsResponse\x12B\n" +
	"\n" +
	"collectors\x18\x01 \x03(\v2\".deployment.v1alpha1.CollectorViewR\n" +
	"collectors\"\x8c\x01\n" +
	"\rCollectorView\x12=\n" +
	"\x04desc\x18\x01 \x01(\v2).deployment.v1alpha1.CollectorDescriptionR\x04desc\x12<\n" +
...
var file_pkg_api_deployment_v1alpha1_deployment_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_pkg_api_deployment_v1alpha1_deployment_proto_goTypes = []any{
	...
	(*GetCollectorRequest)(nil),         // 15: deployment.v1alpha1.GetCollectorRequest
	(*GetCollectorResponse)(nil),        // 16: deployment.v1alpha1.GetCollectorResponse
	(*GetCollectorStatusRequest)(nil),   // 17: deployment.v1alpha1.GetCollectorStatusRequest
	(*GetCollectorStatusResponse)(nil),  // 18: deployment.v1alpha1.GetCollectorStatusResponse
	(*DeleteCollectorRequest)(nil),      // 19: deployment.v1alpha1.DeleteCollectorRequest
	(*CollectorStatus)(nil),             // 20: deployment.v1alpha1.CollectorStatus
	...
	nil,                                 // 35: deployment.v1alpha1.MatchRouterRequest.IdentifyingLabelsEntry
	nil,                                 // 36: deployment.v1alpha1.MatchRouterRequest.NonIdentifyingLabelsEntry
	nil,                                 // 37: deployment.v1alpha1.MatchRouterRequest.OtelfleetLabelsEntry
	nil,                                 // 38: deployment.v1alpha1.CollectorDescription.AttributesEntry
	nil,                                 // 39: deployment.v1alpha1.ComponentHealth.ComponentHealthMapEntry
	nil,                                 // 40: deployment.v1alpha1.CollectorConfigMap.ConfigMapEntry
	(*v1alpha1.Router)(nil),             // 41: route.v1alpha1.Router
	(*timestamppb.Timestamp)(nil),       // 42: google.protobuf.Timestamp
	(*emptypb.Empty)(nil),               // 43: google.protobuf.Empty
}
var file_pkg_api_deployment_v1alpha1_deployment_proto_depIdxs = []int32{
	41, // 0: deployment.v1alpha1.ValidateRouterRequest.router:type_name -> route.v1alpha1.Router
	41, // 1: deployment.v1alpha1.PreviewRouterRequest.router:type_name -> route.v1alpha1.Router
	...
	41, // 5: deployment.v1alpha1.MatchRouterRequest.router:type_name -> route.v1alpha1.Router
	35, // 6: deployment.v1alpha1.MatchRouterRequest.identifying_labels:type_name -> deployment.v1alpha1.MatchRouterRequest.IdentifyingLabelsEntry
	36, // 7: deployment.v1alpha1.MatchRouterRequest.non_identifying_labels:type_name -> deployment.v1alpha1.MatchRouterRequest.NonIdentifyingLabelsEntry
	37, // 8: deployment.v1alpha1.MatchRouterRequest.otelfleet_labels:type_name -> deployment.v1alpha1.MatchRouterRequest.OtelfleetLabelsEntry
	28, // 9: deployment.v1alpha1.GetCollectorHistoryResponse.effective_config:type_name -> deployment.v1alpha1.EffectiveConfig
	14, // 10: deployment.v1alpha1.ListCollectorsResponse.collectors:type_name -> deployment.v1alpha1.CollectorView
	21, // 11: deployment.v1alpha1.CollectorView.desc:type_name -> deployment.v1alpha1.CollectorDescription
	20, // 12: deployment.v1alpha1.CollectorView.status:type_name -> deployment.v1alpha1.CollectorStatus
	21, // 13: deployment.v1alpha1.GetCollectorResponse.collector:type_name -> deployment.v1alpha1.CollectorDescription
	20, // 14: deployment.v1alpha1.GetCollectorStatusResponse.status:type_name -> deployment.v1alpha1.CollectorStatus
	27, // 15: deployment.v1alpha1.CollectorStatus.health:type_name -> deployment.v1alpha1.ComponentHealth
	28, // 16: deployment.v1alpha1.CollectorStatus.effective_config:type_name -> deployment.v1alpha1.EffectiveConfig
	31, // 17: deployment.v1alpha1.CollectorStatus.remote_config_status:type_name -> deployment.v1alpha1.RemoteConfigStatus
	32, // 18: deployment.v1alpha1.CollectorStatus.conn_status:type_name -> deployment.v1alpha1.ConnectionStatus
	33, // 19: deployment.v1alpha1.CollectorStatus.sync_status:type_name -> deployment.v1alpha1.SyncStatus
	...
	38, // 22: deployment.v1alpha1.CollectorDescription.attributes:type_name -> deployment.v1alpha1.CollectorDescription.AttributesEntry
	23, // 23: deployment.v1alpha1.KeyValue.value:type_name -> deployment.v1alpha1.AnyValue
	24, // 24: deployment.v1alpha1.AnyValue.array_value:type_name -> deployment.v1alpha1.ArrayValue
	25, // 25: deployment.v1alpha1.AnyValue.kvlist_value:type_name -> deployment.v1alpha1.KeyValueList
	23, // 26: deployment.v1alpha1.ArrayValue.values:type_name -> deployment.v1alpha1.AnyValue
	22, // 27: deployment.v1alpha1.KeyValueList.values:type_name -> deployment.v1alpha1.KeyValue
	0,  // 28: deployment.v1alpha1.CollectorConnectionState.state:type_name -> deployment.v1alpha1.CollectorState
	42, // 29: deployment.v1alpha1.CollectorConnectionState.last_seen:type_name -> google.protobuf.Timestamp
	42, // 30: deployment.v1alpha1.CollectorConnectionState.connected_at:type_name -> google.protobuf.Timestamp
	42, // 31: deployment.v1alpha1.CollectorConnectionState.disconnected_at:type_name -> google.protobuf.Timestamp
	39, // 32: deployment.v1alpha1.ComponentHealth.component_health_map:type_name -> deployment.v1alpha1.ComponentHealth.ComponentHealthMapEntry
	29, // 33: deployment.v1alpha1.EffectiveConfig.config_map:type_name -> deployment.v1alpha1.CollectorConfigMap
	40, // 34: deployment.v1alpha1.CollectorConfigMap.config_map:type_name -> deployment.v1alpha1.CollectorConfigMap.ConfigMapEntry
	2,  // 35: deployment.v1alpha1.RemoteConfigStatus.status:type_name -> deployment.v1alpha1.RemoteConfigStatuses
	0,  // 36: deployment.v1alpha1.ConnectionStatus.state:type_name -> deployment.v1alpha1.CollectorState
	42, // 37: deployment.v1alpha1.ConnectionStatus.last_seen:type_name -> google.protobuf.Timestamp
	42, // 38: deployment.v1alpha1.ConnectionStatus.connected_at:type_name -> google.protobuf.Timestamp
	42, // 39: deployment.v1alpha1.ConnectionStatus.disconnected_at:type_name -> google.protobuf.Timestamp
	1,  // 40: deployment.v1alpha1.SyncStatus.status:type_name -> deployment.v1alpha1.ConfigSyncStatus
	27, // 41: deployment.v1alpha1.ComponentHealth.ComponentHealthMapEntry.value:type_name -> deployment.v1alpha1.ComponentHealth
	30, // 42: deployment.v1alpha1.CollectorConfigMap.ConfigMapEntry.value:type_name -> deployment.v1alpha1.CollectorConfigFile
	12, // 43: deployment.v1alpha1.CollectorService.ListCollectors:input_type -> deployment.v1alpha1.ListCollectorsRequest
	15, // 44: deployment.v1alpha1.CollectorService.GetCollector:input_type -> deployment.v1alpha1.GetCollectorRequest
	10, // 45: deployment.v1alpha1.CollectorService.CollectorHistory:input_type -> deployment.v1alpha1.GetCollectorHistoryRequest
	17, // 46: deployment.v1alpha1.CollectorService.Status:input_type -> deployment.v1alpha1.GetCollectorStatusRequest
	19, // 47: deployment.v1alpha1.CollectorService.DeleteCollector:input_type -> deployment.v1alpha1.DeleteCollectorRequest
	3,  // 48: deployment.v1alpha1.CollectorService.ValidateRouter:input_type -> deployment.v1alpha1.ValidateRouterRequest
	5,  // 49: deployment.v1alpha1.CollectorService.PreviewRouter:input_type -> deployment.v1alpha1.PreviewRouterRequest
	8,  // 50: deployment.v1alpha1.CollectorService.MatchRouter:input_type -> deployment.v1alpha1.MatchRouterRequest
	13, // 51: deployment.v1alpha1.CollectorService.ListCollectors:output_type -> deployment.v1alpha1.ListCollectorsResponse
	16, // 52: deployment.v1alpha1.CollectorService.GetCollector:output_type -> deployment.v1alpha1.GetCollectorResponse
	11, // 53: deployment.v1alpha1.CollectorService.CollectorHistory:output_type -> deployment.v1alpha1.GetCollectorHistoryResponse
	18, // 54: deployment.v1alpha1.CollectorService.Status:output_type -> deployment.v1alpha1.GetCollectorStatusResponse
	43, // 55: deployment.v1alpha1.CollectorService.DeleteCollector:output_type -> google.protobuf.Empty
	4,  // 56: deployment.v1alpha1.CollectorService.ValidateRouter:output_type -> deployment.v1alpha1.ValidateRouterResponse
	6,  // 57: deployment.v1alpha1.CollectorService.PreviewRouter:output_type -> deployment.v1alpha1.PreviewRouterResponse
	9,  // 58: deployment.v1alpha1.CollectorService.MatchRouter:output_type -> deployment.v1alpha1.MatchRouterResponse
